...
import com.example.accesskeybackend.utils.IPv6Validator.service.IPv6ServiceImpl;
...
public class IPv6ValidatorController {
    ...
    public IPv6ValidatorController(IPv6ServiceImpl iPv6Service) {
        this.iPv6Service = iPv6Service;
    }


    IPv6ServiceImpl iPv6Service;
